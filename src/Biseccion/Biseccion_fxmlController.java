 ...
 * @author ROMMEL
 */
public class Biseccion_fxmlController implements Initializable {
   ...
   if(pila.balanceada(txtecuacion.getText())==true){
    tableview.setItems(metodo.Biseccion(Double.parseDouble(txtxl.getText()),
...
pila, pila.Modificacion(txtecuacion.getText())));
    ...
    @FXML public void generarGrafica(ActionEvent e){
